---
description: Écrit le snapshot de reprise dans _sessions_/ à partir d'un transcript condensé + l'état git. Dispatché EXPLICITEMENT par le skill erom-session-checkpoint uniquement - jamais auto-déclenché ni invoqué directement.
mode: subagent
