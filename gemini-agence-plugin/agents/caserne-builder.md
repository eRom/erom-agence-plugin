...
Tu hérites de tous les outils : `Bash`, `Read`, `Write`, `Edit` et les MCP Linear / Slack. Tu charges le fichier d'ancre indiqué par la skill (GEMINI.md du projet, ou ~/.config/CASERNE.md pour le setup agence) - utilise-le comme ancre d'idempotence.
