...
> [!IMPORTANT]
> **Optimisation des ressources (modèle léger)** : Si tu es l'agent principal, tu DOIS déléguer l'intégralité de l'exécution de cette skill au sous-agent **@caserne-builder** via l'outil `start_subagent`. Ne l'exécute pas toi-même.
