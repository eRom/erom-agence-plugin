...
| ------------------ | -------------------------- | ------ | -------------------------------------------------- |
| Codex        | Codex-agence-plugin/      | maître | https://github.com/eRom/caserne-Codex-plugin      |
