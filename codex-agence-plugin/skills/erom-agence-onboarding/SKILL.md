...
> [!IMPORTANT]
> Codex ne lance pas automatiquement cette skill dans un sous-agent depuis le frontmatter Claude. Si tu es l'agent principal, délègue l'exécution complète au sous-agent `erom-builder`, puis synthétise uniquement son résultat final.
