---
name: erom-session-continue
description: "Reprise de session après /clear : charge le dernier snapshot _sessions_/ (eager : Objectif + NEXT STEP ; lazy : le reste), restaure le contexte git, et annonce où on reprend. Déclenchement explicite (/erom-session-continue)."
---

# erom-session-continue
